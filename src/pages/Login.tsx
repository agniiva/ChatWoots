            ...
            <div className="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/50 overflow-hidden">
                <div className="p-8">
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-bold text-jungle-900">Welcome Back</h1>
                        <p className="text-slate-500 mt-2">Sign in to continue to ChatWoot</p>
                    </div>
                    ...
                    <p className="mt-8 text-center text-sm text-slate-500">
                        ...
                        <Link to="/signup" className="font-semibold text-jungle-600 hover:text-jungle-700">
                            Sign up
                        </Link>
                    </p>
                </div>
